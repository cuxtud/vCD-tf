...
resource "vcd_ip_space_ip_allocation" "_172_16_0_0_24" {
  org_id      = vcd_org.my-org.id
  ip_space_id = vcd_ip_space.space1.id
  type        = "IP_PREFIX"
  value       = "172.16.0.0/24"  
...
resource "vcd_ip_space_ip_allocation" "_192_168_0_0_24" {
  org_id      = vcd_org.my-org.id
  ip_space_id = vcd_ip_space.space1.id
  type        = "IP_PREFIX"
...
resource "vcd_ip_space_ip_allocation" "_192_168_50_0_25" {
  org_id      = vcd_org.my-org.id
  ip_space_id = vcd_ip_space.space1.id
  type        = "IP_PREFIX"
...
resource "vcd_ip_space_ip_allocation" "_172_17_0_0_25" {
  org_id      = vcd_org.my-org.id
  ip_space_id = vcd_ip_space.space1.id
  type        = "IP_PREFIX"
  value       = "172.17.0.0/25"  
...
resource "vcd_ip_space_ip_allocation" "_10_1_0_0_25" {
  org_id      = vcd_org.my-org.id
  ip_space_id = vcd_ip_space.space1.id
  type        = "IP_PREFIX"
  value       = "10.1.0.0/25"  
...
resource "vcd_ip_space_ip_allocation" "_192_168_100_0_26" {
  org_id      = vcd_org.my-org.id
  ip_space_id = vcd_ip_space.space1.id
  type        = "IP_PREFIX"
...
resource "vcd_ip_space_ip_allocation" "_172_18_0_0_26" {
  org_id      = vcd_org.my-org.id
  ip_space_id = vcd_ip_space.space1.id
  type        = "IP_PREFIX"
  value       = "172.18.0.0/26"  
...
resource "vcd_ip_space_ip_allocation" "_10_2_0_0_26" {
  org_id      = vcd_org.my-org.id
  ip_space_id = vcd_ip_space.space1.id
  type        = "IP_PREFIX"
  value       = "10.2.0.0/26"  
